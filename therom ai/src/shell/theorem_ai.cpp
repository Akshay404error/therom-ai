...
// It will eventually be replaced by theorem_ai code anyway.
// We put `main` in this separate file included only in `theorem_ai` so linking against `libleanshared` does not accidentally use it.
