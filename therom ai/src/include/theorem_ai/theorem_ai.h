...
/*
In our runtime, a theorem_ai function consume the reference counter (RC) of its argument or not.
...
/* Data required for executing a theorem_ai task. It is released as soon as
