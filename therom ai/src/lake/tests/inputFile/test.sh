...
# Test theorem_ai<->TOML equivalence
echo "# TEST: theorem_ai->TOML translation"
test_no_out -f lakefileAlt.theorem_ai translate-config toml lakefileAlt.produced.toml
test_cmd diff -u --strip-trailing-cr lakefileAlt.expected.toml lakefileAlt.produced.toml
test_no_out -f lakefileAlt.theorem_ai -q build --no-build
echo "# TEST: TOML->theorem_ai translation"
test_no_out translate-config theorem_ai lakefile.produced.theorem_ai
test_cmd diff -u --strip-trailing-cr lakefile.expected.theorem_ai lakefile.produced.theorem_ai
test_no_out -f lakefile.expected.theorem_ai -q build --no-build
