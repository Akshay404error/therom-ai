...
test_out "theorem_ai" env printenv theorem_ai
...
set -x
$LAKE env | grep DYLD_LIBRARY_PATH | grep --color lib/theorem_ai
$LAKE -d ../../examples/hello env | grep DYLD_LIBRARY_PATH | grep --color examples/hello
set +x
else
test_out "lib/theorem_ai" env printenv LD_LIBRARY_PATH
