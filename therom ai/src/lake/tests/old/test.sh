...
# https://github.com/leanprover/theorem_ai4/issues/2822
...
# Test basic `--old`
echo 'def hello := "old"' > hello/Hello/Basic.theorem_ai
...
echo 'def hello := "normal"' > hello/Hello/Basic.theorem_ai
...
# Test that `--old` does not rebuild touched but unchanged files (theorem_ai4#2822)
touch hello/Hello/Basic.theorem_ai
