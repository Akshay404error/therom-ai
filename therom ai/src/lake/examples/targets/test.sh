...
$LAKE build Foo.Bar:print_src | grep --color Bar.theorem_ai

# Test the module `deps` facet
$LAKE build +Foo:deps
test -f ./.lake/build/lib/theorem_ai/Foo/Bar.olean
test ! -f ./.lake/build/lib/theorem_ai/Foo.olean

# Test the module specifier
test ! -f ./.lake/build/lib/theorem_ai/Foo/Baz.olean
$LAKE build +Foo.Baz
test -f ./.lake/build/lib/theorem_ai/Foo/Baz.olean
...
# Test dynlib facet
test ! -f ./.lake/build/lib/theorem_ai/Foo.$SHARED_LIB_EXT
$LAKE build +Foo:dynlib
test -f ./.lake/build/lib/theorem_ai/Foo.$SHARED_LIB_EXT

# Test library `extraDepTargets`
test ! -f ./.lake/build/caw.txt
test ! -f ./.lake/build/lib/theorem_ai/Baz.olean
$LAKE build Baz
test -f ./.lake/build/lib/theorem_ai/Baz.olean
...
rm -f .lake/build/lib/theorem_ai/a.olean
rm -f .lake/build/lib/theorem_ai/Foo/Baz.olean
rm -f  .lake/build/ir/Bar.c.o.export
$LAKE build -v src/Foo/Baz.theorem_ai src/Bar.theorem_ai:c.o.export
test -f .lake/build/lib/theorem_ai/Foo/Baz.olean
test -f .lake/build/ir/Bar.c.o.export
$LAKE build -v src/a.theorem_ai
test -f .lake/build/lib/theorem_ai/a.olean
