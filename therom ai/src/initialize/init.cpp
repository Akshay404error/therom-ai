...
/* Initializes the theorem_ai runtime. Before executing any code which uses the theorem_ai package,
you must first call this function, and then `theorem_ai::io_mark_end_initialization`. In between
...
extern "C" LEAN_EXPORT void lean_initialize() {
    ...
    // via `import`, such as:
    // * calling exported theorem_ai functions from C++
...
initializer::initializer() {
    lean_initialize();
    /* Remark: We used to call `theorem_ai::io_mark_end_initialization` here, however this prevented
