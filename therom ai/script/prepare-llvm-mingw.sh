...
# ```
# eval cmake ../.. $(../../script/prepare-llvm-mingw.sh ~/Downloads/theorem_ai-llvm-x86_64-w64-windows-gnu.tar.zst)
# ```
...
# be delivered to users via Windows Update without having to recompile theorem_ai or theorem_ai programs.
