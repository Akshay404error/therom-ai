...
# as C++ name objects.
#
# This script is used to generate src/frontends/theorem_ai/tokens.cpp and src/frontends/theorem_ai/tokens.h
# from src/frontends/theorem_ai/tokens.txt
import sys
import os
