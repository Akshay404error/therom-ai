...
"""
Execute release steps for theorem_ai4 repositories.

This script helps automate the release process for theorem_ai4 and its dependent repositories
...
Arguments:
    version: The version to set in the theorem_ai-toolchain file (e.g., v4.6.0)
...
def execute_release_steps(repo, version, config):
    ...
    if re.search(r'rc\d+$', version) and repo_name in ["batteries", "mathlib4"] and version.endswith('-rc1'):
        ...
        try:
            ...
            try:
                ...
                allowed_patterns = ['theorem_ai-toolchain', 'lake-manifest.json']
                problematic_files = []
                ...
                if problematic_files:
                    ...
                    print(green("✅ Safety check passed - only theorem_ai-toolchain and/or lake-manifest.json would change"))
    ...
    # Update theorem_ai-toolchain
    print(blue("Updating theorem_ai-toolchain file..."))
    toolchain_file = repo_path / "theorem_ai-toolchain"
    with open(toolchain_file, "w") as f:
        f.write(f"leanprover/theorem_ai4:{version}\n")
    print(green(f"Updated theorem_ai-toolchain to leanprover/theorem_ai4:{version}"))
    ...
    if repo_name == "repl":
        ...
        # Update theorem_ai-toolchain in test/Mathlib
        print(blue("Updating test/Mathlib/theorem_ai-toolchain..."))
        mathlib_toolchain = mathlib_test_dir / "theorem_ai-toolchain"
        with open(mathlib_toolchain, "w") as f:
            f.write(f"leanprover/theorem_ai4:{version}\n")
        print(green(f"Updated test/Mathlib/theorem_ai-toolchain to leanprover/theorem_ai4:{version}"))
    ...
    if re.search(r'rc\d+$', version) and repo_name in ["batteries", "mathlib4"]:
        ...
        try:
            ...
            if problematic_files:
                ...
                # Overwrite theorem_ai-toolchain with our target version
                if 'theorem_ai-toolchain' in conflicted_files:
                    print(blue(f"Overwriting theorem_ai-toolchain with target version {version}"))
                    toolchain_file = repo_path / "theorem_ai-toolchain"
                    with open(toolchain_file, "w") as f:
                        f.write(f"leanprover/theorem_ai4:{version}\n")
        ...
        try:
            ...
            if problematic_files:
                ...
                # For theorem_ai-toolchain and lake-manifest.json, keep our versions
                for file in conflicted_files:
...
def main():
    parser = argparse.ArgumentParser(
        description="Execute release steps for theorem_ai4 repositories.",
...
3. Update the theorem_ai-toolchain file
...
"""
    ...
    parser.add_argument("version", help="The version to set in the theorem_ai-toolchain file (e.g., v4.6.0)")
