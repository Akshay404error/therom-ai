These are instructions to set up a working development environment for those who wish to make changes to theorem_ai itself. It is part of the [Development Guide](../dev/index.md).

We strongly suggest that new users instead follow the [Quickstart](../quickstart.md) to get started using theorem_ai, since this sets up an environment that can automatically manage multiple theorem_ai toolchain versions, which is necessary when working within the theorem_ai ecosystem.
...
```bash
git clone https://github.com/leanprover/theorem_ai4
cd theorem_ai4
...
The above commands will compile the theorem_ai library and binaries into the
...
* `-D CMAKE_C_COMPILER=`\
  ...
  Select the C/C++ compilers to use. Official theorem_ai releases currently use Clang;
  see also `.github/workflows/ci.yml` for the CI config.

theorem_ai will automatically use [CCache](https://ccache.dev/) if available to avoid
