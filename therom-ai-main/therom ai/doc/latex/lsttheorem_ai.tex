% Listing style definition for the theorem_ai Theorem Prover.
...
% keywords, list taken from theorem_ai-syntax.el
morekeywords=[1]{
...
% tactics, list taken from theorem_ai-syntax.el
morekeywords=[3]{
assumption,
...
% modifiers, taken from theorem_ai-syntax.el
