...
public:
    ...
    names get_all_inductive_names() const {
        return ::theorem_ai::get_all_inductive_names(m_ind_types);
    }
    ...
    bool is_valid_ind_app(expr const & t, unsigned i) {
        ...
        Such occurrences are unsound in general. https://github.com/leanprover/theorem_ai4/issues/2125
        We also used to reject them in theorem_ai 3.
        */
