...
/* This is the implementation in theorem_ai */
...
inline bool has_expr_mvar(expr const & e) {
    ...
    lean_assert(r == has_expr_mvar_core(e)); // ensure the C++ implementation matches the theorem_ai one.
    return r;
}
bool has_univ_mvar_core(expr const & e);
inline bool has_univ_mvar(expr const & e) {
    bool r = ((get_data(e) >> 42) & 1) == 1;
    lean_assert(r == has_univ_mvar_core(e)); // ensure the C++ implementation matches the theorem_ai one.
    return r;
}
...
inline bool has_fvar(expr const & e) {
    ...
    lean_assert(r == has_fvar_core(e)); // ensure the C++ implementation matches the theorem_ai one.
    return r;
}
...
inline bool            let_nondep(expr const & e) {
    ...
    lean_assert(r == let_nondep_core(e)); // ensure the C++ implementation matches the theorem_ai one.
    return r;
}
