...
test_status $NO_BUILD_CODE setup-file ImportTest.theorem_ai --no-build
test ! -f .lake/build/lib/theorem_ai/Test.olean
test_run build Test
test -f .lake/build/lib/theorem_ai/Test.olean
test_run setup-file ImportTest.theorem_ai --no-build
