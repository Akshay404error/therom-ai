...
test_cmd rm .lake/build/lib/theorem_ai/Test.olean .lake/build/lib/theorem_ai/Test.ilean
LAKE_CACHE_DIR="$CACHE_DIR" test_out "restored artifact from cache" -v build +Test --no-build
test_exp -f .lake/build/lib/theorem_ai/Test.olean
test_exp -f .lake/build/lib/theorem_ai/Test.ilean
...
# Cleanup
rm -f produced.out Ignored.theorem_ai
