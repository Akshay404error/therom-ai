...
#include "frontends/theorem_ai/pp.h"
#include "frontends/theorem_ai/parser.h"
#include "init/init.h"
#include "frontends/theorem_ai/simple_pos_info_provider.h"
...
static theorem_ai::initializer * g_init = nullptr;
static theorem_ai::emscripten_shell * g_shell = nullptr;

void initialize_emscripten() {
    g_init  = new theorem_ai::initializer();
    g_shell = new theorem_ai::emscripten_shell();
}
