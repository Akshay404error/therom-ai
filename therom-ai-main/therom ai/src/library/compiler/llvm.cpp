...
`src/theorem_ai/Compiler/IR/EmitLLVM.theorem_ai` to produce LLVM bitcode from
theorem_ai's IR.
*/
...
// == LLVM <-> theorem_ai: PassManagerRef ==
...
LLVMTypeRef *array_ref_to_ArrayLLVMType(
    const theorem_ai::array_ref<lean_object *> &arr) {
#ifndef LEAN_LLVM
    lean_always_assert(
        false && ("Please build a version of theorem_ai4 with -DLLVM=ON to invoke "
                  "the LLVM backend function."));
#else
    const int nargs = arr.size();  // theorem_ai::array_size(args);
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_get_named_function(
    ...
    return lean_io_result_mk_ok(
        f ? theorem_ai::mk_option_some(lean_box_usize(Value_to_lean(f)))
          : theorem_ai::mk_option_none());
#endif  // LEAN_LLVM
}
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_get_named_global(
    ...
    return lean_io_result_mk_ok(
        g ? theorem_ai::mk_option_some(lean_box_usize(Value_to_lean(g)))
          : theorem_ai::mk_option_none());
#endif  // LEAN_LLVM
}
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_global_string(
    ...
    lean_always_assert(
        false && ("Please build a version of theorem_ai4 with -DLLVM=ON to invoke "
                  "the LLVM backend function."));
#else
    theorem_ai::string_ref sref = theorem_ai::string_ref(str, true);
    theorem_ai::string_ref nameref = theorem_ai::string_ref(name, true);
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_function_type(
    ...
    lean_always_assert(
        false && ("Please build a version of theorem_ai4 with -DLLVM=ON to invoke "
                  "the LLVM backend function."));
#else
    theorem_ai::array_ref<lean_object *> arr(argtys, true);
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_call2(
    ...
    lean_always_assert(
        false && ("Please build a version of theorem_ai4 with -DLLVM=ON to invoke "
                  "the LLVM backend function."));
#else
    theorem_ai::array_ref<lean_object *> arr(args, true);
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_inbounds_gep2(size_t ctx,
    ...
    theorem_ai::array_ref<lean_object *> indices_array_ref(indices, true);
    LLVMValueRef *indices_carr = array_ref_to_ArrayLLVMValue(indices_array_ref);
    theorem_ai::string_ref name_ref(name, true);
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_print_module_to_string(size_t ctx,
    ...
    return lean_io_result_mk_ok(theorem_ai::mk_string(s));
#endif  // LEAN_LLVM
}
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_const_array(
    ...
    lean_always_assert(
        false && ("Please build a version of theorem_ai4 with -DLLVM=ON to invoke "
                  "the LLVM backend function."));
#else
    theorem_ai::array_ref<lean_object *> args_array_ref(args, true);
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_const_string(
    ...
    theorem_ai::string_ref sref = theorem_ai::string_ref(s, true);
#ifndef LEAN_LLVM
    lean_always_assert(
        false && ("Please build a version of theorem_ai4 with -DLLVM=ON to invoke "
                  "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_get_default_target_triple(lean_object * /* w */) {
    ...
    lean_object *out = theorem_ai::mk_string(triple);
    free(triple);
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_get_value_name2(size_t ctx, size_t value,
    ...
    return lean_io_result_mk_ok(theorem_ai::mk_string(name));
#endif  // LEAN_LLVM
}
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_verify_module(size_t ctx, size_t mod,
    ...
    if (broken) {
      return lean_io_result_mk_ok(theorem_ai::mk_option_some(lean_mk_string(msg)));
    } else {
      return lean_io_result_mk_ok(theorem_ai::mk_option_none());
    }
#endif  // LEAN_LLVM
}
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_get_first_instruction(size_t ctx, size_t bb,
    ...
    if (instr_ref == NULL) {
       ...
       return lean_io_result_mk_ok(theorem_ai::mk_option_some(lean_box_usize(Value_to_lean(instr_ref))));
    }
#endif  // LEAN_LLVM
}
